...
@section('content') 
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <a class="card bg-gradient-custom-indigo border-0 text-decoration-none">
                <div class="card-body d-flex align-items-center text-white">
                    <div class="flex-fill">
                        <div class="mb-1">ESTUDIOS</div>
                        <h2>{{ $consultaestudios }}</h2>
                    </div>
                    <div class="opacity-5">
                            <i class="fa fa-archive fa-6x"></i>
                    </div>
                </div>
            </a>
        </div>  
            ...
            <a class="card bg-gradient-orange-red border-0 text-decoration-none">
                <div class="card-body d-flex align-items-center text-white">
                    <div class="flex-fill">
                        ...
                        <h2>{{ $consultaestudios-$consultalecturas }}</h2>
                    </div>
                    <div class="opacity-5">
